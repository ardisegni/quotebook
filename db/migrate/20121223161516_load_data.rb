class LoadData < ActiveRecord::Migration
  ...
  def self.up
    ...
    funny = User.create(:first_name => "<Funny>", :last_name => "&lt;name")
     ...
     # Create initial perlas.
      jb = Perla.create(:first_name => "Justin", :last_name => "Bieber")
      ph = Perla.create(:first_name => "Paris",  :last_name => "Hilton")
      bh = Perla.create(:first_name => "Barack", :last_name => "Obama")
      jo = Perla.create(:first_name => "John", :last_name => "Ousterhout")
      funny = Perla.create(:first_name => "<Funny>", :last_name => "&lt;name")
